...
window.SKY_FORCE_STAGES['stage-01'] = {
  ...
  timeline: [
    ...
    { atSec: 8, action: 'spawnDestructible', destructible: 'crate', x: 0.22, y: 0.72 },
    { atSec: 8, action: 'spawnDestructible', destructible: 'crate', x: 0.78, y: 0.68 },
    ...
    { atSec: 32, action: 'spawnDestructible', destructible: 'radar', x: 0.5, y: 0.78 },
    ...
    { atSec: 45, action: 'spawnDestructible', destructible: 'fuel', x: 0.18, y: 0.75 },
    { atSec: 48, action: 'spawnDestructible', destructible: 'fuel', x: 0.82, y: 0.73 },
